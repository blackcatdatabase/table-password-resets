...
class PasswordResetRepository implements PasswordResetRepositoryInterface, RepoContract, KeysetRepoContract
{
use OrderByTools, PkTools, RepositoryHelpers;
    ...
    /** @return array<string,mixed>|\BlackCat\Database\Packages\PasswordResets\Dto\PasswordResetDto|null */
    public function getBySelector(string $selector, bool $asDto = false): array|\BlackCat\Database\Packages\PasswordResets\Dto\PasswordResetDto|null {
