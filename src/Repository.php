...
use BlackCat\Database\Packages\PasswordResets\Repository\PasswordResetRepository as GeneratedRepository;
...
{
  private PasswordResetRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof PasswordResetRepositoryInterface) {
            throw new \InvalidArgumentException('Expected PasswordResetRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PasswordResets\Dto\PasswordResetDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PasswordResets\Dto\PasswordResetDto|null { return $this->repo->getById($id, $asDto); }
