...
final class Criteria extends BaseCriteria
{
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\PasswordResets\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\PasswordResets\Definitions::softDeleteColumn();
