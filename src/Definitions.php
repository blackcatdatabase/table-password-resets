...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'password_resets'; }
    public static function contractView(): string { return 'vw_password_resets'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'user_id', 'token_hash', 'selector', 'validator_hash', 'key_version', 'expires_at', 'created_at', 'used_at', 'ip_hash', 'ip_hash_key_version', 'user_agent' ]; }
