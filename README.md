...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 5 · Changelog: n/a
...
| Pkg folder | [packages/password-resets](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/password-resets) | Repo location |
...
graph LR
  ...
  password_resets["password_resets"]:::center
  password_resets -->|FK| users["users"]:::link
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package password-resets -Apply
